...
The original external temporal-validation recording is publicly available on
YouTube:

**Video:** [Watch the external-validation recording on YouTube](https://www.youtube.com/watch?v=PoPD37uxxqw))
...
Users should cite the original video source, the associated dataset record, and
the research article when reproducing or extending the external-validation
analysis.
